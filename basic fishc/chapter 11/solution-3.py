...
# 3. 类函数-静态函数-实例函数; 无同名, 类名、都能访问外部; 同名覆盖, 外部彻底没了, 只能self访问内
class P3Class:
    @classmethod
    def p3cm1(cls):
        print("类函数1")
    ...
    @staticmethod
    def p3sm1():
        print("静态函数1")  # 静态函数较之类函数, 不会自动传入类参数; 其实就是写在类里的最一般函数
    @staticmethod
    def p3sm2():
        print("静态函数2")
...
# 4. 父类-子类之类变量; 无同名, 父类名、super()、子类名都能访问外部; 同名覆盖, 外部仍存在,
